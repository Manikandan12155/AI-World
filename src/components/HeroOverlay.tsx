...
export const HeroOverlay: React.FC<HeroOverlayProps> = ({ onExploreWorld }) => {
  return (
    <div className="relative w-full h-full pointer-events-none select-none flex flex-col justify-between px-8 md:px-12 pt-16 pb-2">
      {/* Upper Content Area: Left Headline & Right Quote */}
      <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mt-[3.3rem]">
        {/* Left Side: Headline & Mission */}
        <div className="max-w-[535px] pointer-events-auto">
          {/* Small Eyebrow */}
          <div className="text-[12px] font-semibold tracking-[0.36em] text-blue-100/80 uppercase mb-4 flex items-center gap-2">
            <span>GLOBAL TECHNOLOGY INTELLIGENCE</span>
          </div>

          {/* Large Headline */}
          <h1 className="text-5xl sm:text-6xl lg:text-[62px] font-extrabold tracking-[-0.02em] text-white leading-[1.03] font-['Space_Grotesk'] mb-6 drop-shadow-[0_8px_32px_rgba(0,0,0,0.35)]">
            A Smarter
            <br />
            Tomorrow{' '}
          ...
          {/* Supporting Text */}
          <p className="text-base text-slate-200/90 font-normal leading-[1.65] mb-8 max-w-[450px]">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="group flex items-center gap-3 px-8 py-3.5 rounded-full bg-[#0b2245]/88 hover:bg-[#12315a] border border-cyan-300/72 hover:border-cyan-200 text-white text-sm font-semibold tracking-wide shadow-[0_0_26px_rgba(59,130,246,0.65),inset_0_0_22px_rgba(96,165,250,0.18)] transition-all duration-300 hover:scale-[1.02]"
            >
  ...
  <div className="flex items-center gap-0 mt-4 pointer-events-auto mb-6">
    <div className="flex flex-col pr-7 md:pr-8">
      <span className="text-2xl font-bold tracking-tight text-blue-100 font-['Space_Grotesk']">
        100K+
      </span>
      <span className="text-[11px] text-slate-400 tracking-wide mt-0.5">Tech Updates</span>
    </div>
    <div className="flex flex-col px-7 md:px-8 border-l border-blue-200/20">
      <span className="text-2xl font-bold tracking-tight text-blue-100 font-['Space_Grotesk']">
        10K+
      </span>
      <span className="text-[11px] text-slate-400 tracking-wide mt-0.5">Tools & Resources</span>
    </div>
    <div className="flex flex-col pl-7 md:pl-8 border-l border-blue-200/20">
      <span className="text-2xl font-bold tracking-tight text-blue-100 font-['Space_Grotesk']">
        50K+
      </span>
      <span className="text-[11px] text-slate-400 tracking-wide mt-0.5">Global Developers</span>
    </div>
  </div>
